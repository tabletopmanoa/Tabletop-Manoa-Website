...
class GameSchema extends BaseCollection {
  ...
  define({ gameName = '', category, maxPlayers = '', gameLength = '', location = '', about = '', picture = '', contact = '', resources = '' }) {
    const checkPattern = {
      gameName: String, maxPlayers: Number, gameLength: String, about: String, location: String, picture: String,
      contact: String
    };
    check({ gameName, maxPlayers, location, gameLength, about, picture, contact }, checkPattern);
